...
import {getLibraryInfoSelector} from "../../../_redux/library-info-module/selectors";
import classnames from "classnames/bind";
import styles from "./index.module.scss";
import {useRoute} from "react-router5";
import {LIST_PAGE_NODE} from "../../../../../../../_constants/page-nodes";
...
export const WrappedComponent = ({library}: PropsType) => {
  const {
    router: {navigate},
  } = useRoute();
